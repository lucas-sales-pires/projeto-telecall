...
EOT;
    ...
    function addImagePng(&$img, $file, $x, $y, $w = 0.0, $h = 0.0, $is_mask = false, $mask = null)
    {
        ...
        if (isset($this->imagelist[$file])) {
            ...
            if ($data == '') {
                $error = 1;
                $mensagemErro = 'trouble writing file from GD';
                //DEBUG_IMG_TEMP
                //debugpng
                if (defined("DEBUGPNG") && DEBUGPNG) {
            ...
            if ($error) {
                $this->addMessage('PNG error - (' . $file . ') ' . $mensagemErro);
        ...
        if (isset($this->imagelist[$file])) {
            ...
            if (!$error) {
                ...
                if (mb_substr($data, 0, 8, '8bit') != $header) {
                    ...
                    $mensagemErro = 'this file does not have a valid header';
                }
            }
            ...
            if (!$error) {
                    ...
                    switch ($chunkType) {
                        case 'IHDR':
                            ...
                            if ($info['compressionMethod'] != 0) {
                                ...
                                $mensagemErro = 'unsupported compression method';
                            }
                            ...
                            if ($info['filterMethod'] != 0) {
                                ...
                                $mensagemErro = 'unsupported filter method';
                            }
                            break;
                ...
                if (!$haveHeader) {
                    ...
                    $mensagemErro = 'information header is missing';
                }
                ...
                if (isset($info['interlaceMethod']) && $info['interlaceMethod']) {
                    ...
                    $mensagemErro = 'There appears to be no support for interlaced images in pdf.';
                }
            }
            ...
            if (!$error && $info['bitDepth'] > 8) {
                ...
                $mensagemErro = 'only bit depth of 8 or less is supported';
            }
            ...
            if (!$error) {
                switch ($info['colorType']) {
                    ...
                    default:
                        ...
                        $mensagemErro = 'transparency alpha channel not supported, transparency only supported for palette images.';
                }
            }
